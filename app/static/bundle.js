...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Components = __webpack_require__(221);

	var _ViewContainer = __webpack_require__(223);
	...
	var routes = _react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'view', component: _ViewContainer.ViewContainer })
	  )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.View = exports.Home = exports.Main = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ViewContainer = undefined;
	...
	var ViewContainer = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    _api.api.getData().then(function (data) {
	      this.setState({
	        isLoading: false,
	        text: data.text
	      });
	  ...
	  render: function render() {
	    return _react2.default.createElement(_Components.View, { text: this.state.text });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = {
	  getData: function getData() {
	    return _axios2.default.get('/api').then(function (data) {
	      return data.data;
	    }).catch(function (err) {
